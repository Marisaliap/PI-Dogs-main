...
describe("<CreateDog />", () => {
  describe("Estructura", () => {
    ...
    xit('Renderiza un label con el texto igual a "Image:"', () => {
      // El orden en el que se encuentran los Labels es importante.
      expect(wrapper.find("label").at(4).text()).toEqual("Image:");
    });
    ...
    xit('Renderiza un label con el texto igual a "Choose Temperaments:"', () => {
      // El orden en el que se encuentran los Labels es importante.
      expect(wrapper.find("label").at(5).text()).toEqual("Choose Temperaments:");
    });

    xit('Renderiza un select con la propiedad "name" igual a "temperament"', () => {
